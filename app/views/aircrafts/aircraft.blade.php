	...
	<div class="col-700 last">
		...
		<div class="fixed">
			<div class="portfolio-item col-220">
				<a href="#" class="portfolio-item-preview"> 
					<img src="{{ URL::asset('img/aircraft/stearman.png') }}" width="220" height="140" alt="" /> </a>
				<br />
				<h3>Stearman</h3>
			...
			<div class="portfolio-item col-220">
				<a href="#" class="portfolio-item-preview"> <img src="{{ URL::asset('img/aircraft/tiger-moth.png') }}" width="220" height="140" alt="" /> </a>
				<br />
				<h3>Tiger Moth</h3>
			...
			<div class="portfolio-item col-220 last">
				<a href="#" class="portfolio-item-preview"> <img src="{{ URL::asset('img/aircraft/cap-10c.png') }}" width="220" height="140" alt="" /> </a>
				<br />
				<h3>CAP 10C</h3>
		...
		<div class="fixed">
			<div class="portfolio-item col-220">
				<a href="#" class="portfolio-item-preview"> <img src="{{ URL::asset('img/aircraft/harvard.png') }}" width="220" height="140" alt="" /> </a>
				<br />
				<h3>Harvard</h3>
			...
			<div class="portfolio-item col-220">
				<a href="#" class="portfolio-item-preview"> <img src="{{ URL::asset('img/aircraft/jungmann.png') }}" width="220" height="140" alt="" /> </a>
				<br />
				<h3>Jungmann</h3>
			...
			<div class="portfolio-item col-220 last">
				<a href="#" class="portfolio-item-preview"> <img src="{{ URL::asset('img/aircraft/cap-232.png') }}" width="220" height="140" alt="" /> </a>
				<br />
				<h3>CAP232</h3>
		...
		<div class="fixed">
			<div class="portfolio-item col-220">
				<a href="#" class="portfolio-item-preview"> <img src="{{ URL::asset('img/aircraft/chipmunk.jpg') }}" width="220" height="140" alt="" /> </a>
				<br />
				<h3>Chipmunk</h3>
