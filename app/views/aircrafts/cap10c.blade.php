	...
	<div class="col-700 last">
		<div id="slideshow-portfolio">
			<ul>
				...
				<li><img src="http://placehold.it/700x300" width="700" height="300" alt="" /></li><!-- end slide 2 -->
				<li><img src="http://placehold.it/700x300" width="700" height="300" alt="" /></li><!-- end slide 3 -->
			</ul>
		...
		<div class="col-340">
			...
			<p>Fusce varius euismod lorem, nec semper ante ullamcorper condimentum. Lorem ipsum
			 dolor sit amet, consectetur adipiscing elit. Nam eu tortor eget nunc blandit rutrum. Praesent hendrerit ante sed nulla molestie gravida.</p>
			<p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nullam eu ipsum nec felis facilisis molestie tristique id elit. Vivamus ipsum mi, luctus eu ullamcorper ut, dapibus et elit. Phasellus et mauris eu mi accumsan scelerisque id non lectus. </p>
		</div>
